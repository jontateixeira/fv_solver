function [ S_old, state ] = streamlineMPFAD_2(S_old, influx, bflux, tf, nw, no)
...
global wells q elem elemfluxedge faces inedge bedge courant prd cfg

    opt = struct(...
        'numsline' , cfg.streamline.numsline   , ...
        'max_dt'   , inf        , ...
        'dt_factor', 0.8        , ...
        'satwarn'  , sqrt(eps)  , ...
        'substeps' , cfg.streamline.substeps   , ...
        'maxsteps' , cfg.streamline.maxsteps   );
%         'dt'       , tf);
